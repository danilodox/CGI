...
public class GatoArnold {
    ...
    public void exibeImage() {
        ...
        PanelGatoArnold.panel_imagemF.removeAll();
        PanelGatoArnold.panel_imagemF.add(label);
        PanelGatoArnold.panel_imagemF.validate();
        PanelGatoArnold.panel_imagemF.repaint();
