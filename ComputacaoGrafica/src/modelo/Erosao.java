...
import static modelo.Dilatar.converterBuffered;
...
public class Erosao {
    ...
    public Erosao(int[][] imagem, int width, int height, int times){
        this.imagem = imagem;
        this.width = width;
        this.height = height;
        this.times = times;
    ...
    /**
     * Opeo de eroo morfogica. Nesta opeo buscamos entre o pixel e seus vizinhos
     * aqueles com o tom de cinza mais escuro (de menor valor). Os pixels
     * considerados na busca o aqueles marcados com true no kernel.
     */
    public BufferedImage erodir(BufferedImage img, boolean[][] kernel) {
        ...
        for (int y = 0; y < img.getHeight(); y++) {
            for (int x = 0; x < img.getWidth(); x++) {
                //A eroo busca pelo pixel de menor valor
                int min = 255;
                ...
                for (int ky = 0; ky < 3; ky++) {
                    for (int kx = 0; kx < 3; kx++) {
                        ...
                        //Se ele for mais escuro que o menor  encontrado, substitui
