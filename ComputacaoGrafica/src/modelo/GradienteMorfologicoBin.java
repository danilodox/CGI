 ...
 * @author Peu
 */
public class GradienteMorfologicoBin {
    private int[][] elementoEstruturante;
    private int width, height;
    private int[][] imagem;
    
    public GradienteMorfologicoBin(int[][] imagem, int width, int height){
     ...
     */
    public BufferedImage gradienteMorfologicoBin() {
        int p0 = 0;
        int p255 = 0;
        int pNovo = 0;
        int pNovo2 = 255;
        ...
        int[][] parcial = dilatarBin(width, height, imagem, elementoEstruturante);
        int[][] parcial2 = erodirBin(width, height, imagem, elementoEstruturante);
