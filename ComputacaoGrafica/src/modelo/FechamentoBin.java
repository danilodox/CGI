 ...
 * @author Peu
 */
public class FechamentoBin {
    private int[][] elementoEstruturante;
    private int width, height;
    private int[][] imagem;
    
    public FechamentoBin(int[][] imagem, int width, int height){
     ...
     */
    public BufferedImage fechamentoBin() {
        ...
        matrizImagemBinaria = erodirBin(width, height, parcial, elementoEstruturante);
